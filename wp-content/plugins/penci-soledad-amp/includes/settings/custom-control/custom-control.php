...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Penci_AMP_Customize_Font_Size_Control extends WP_Customize_Control {
	...
	class Penci_AMP_Customize_Number_Control extends WP_Customize_Control {
		public $type = 'number';
	...
	class Penci_AMP_Customize_CustomCss_Control extends WP_Customize_Control {
	...
	class Penci_AMP_Customize_Heading_Control extends WP_Customize_Control {
		public $type = 'heading';
	...
	class Penci_AMP_Customize_Category_Control extends WP_Customize_Control {
		public function render_content() {
			$dropdown = wp_dropdown_categories( array(
				'name'              => '_customize-dropdown-categories-' . $this->id,
				'echo'              => 0,
				'show_option_none'  => esc_html__( '&mdash; Select &mdash;', 'penci-amp' ),
				'option_none_value' => '0',
				'selected'          => $this->value(),
			) );
