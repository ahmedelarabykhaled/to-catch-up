...
require_once( PENCI_AMP_DIR. '/includes/options/class-amp-analytics-options-submenu.php' );
require_once( PENCI_AMP_DIR. '/includes/options/views/class-amp-options-menu-page.php' );
require_once( PENCI_AMP_DIR. '/includes/options/views/class-amp-options-manager.php' );

class Penci_AMP_Options_Menu {
	...
	public function __construct() {
		$this->menu_page = new Penci_AMP_Options_Menu_Page();
		$this->menu_slug = 'amp-plugin-options';
	}

	public function init() {
		add_action( 'admin_post_penci_amp_analytics_options', 'Penci_AMP_Options_Manager::handle_analytics_submit' );
	...
	public function add_menu_items() {
		...
		$submenus = array(
			new Penci_AMP_Analytics_Options_Submenu( $this->menu_slug ),
		);
